            ...
            if (self.e_stop == "Warning" and self.marker_3 == 0):
                ...
                if (self.marker_0 == 1):
                    ...
                    if self.right_count == 0:
                        ...
                        if self.rrr == 1:
                            if (self.roll_average -0.68 >= self.roll):
                                self.marker_1 = 0
                                self.right_count = 0
                                self.rrr = 2
                            else:
                        ...
                        if self.rrr == 2:
                            if (self.parking != "back"):
                                drive_data.linear.x = self.BASE_SPEED
                                drive_data.angular.z = self.roll_average - 0.68 - self.roll
                                ...
                                while(self.parking_loop_time - self.parking_start_time <= 10):
                                    ...
                                    if (self.roll >= self.roll_average - 0.68 and self.roll <= self.roll_average - 0.6):
                                        break
